...
This repo is my personal copy of the public repo for the DeepLearning.AI TensorFlow Developer course on Coursera. The original public repo can be found [here](https://github.com/https-deeplearning-ai/tensorflow-1-public).
